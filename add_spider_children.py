    ...
    for p in range(1, page + 1)[::-1]:
        ...
        for i in d('.cimg')[::-1]:
            ...
            if len(dd('#table_1_normaldivr > ul > li:nth-child(9)').text().split(',')) > 1:
                ...
                missing_location_province = dd('#table_1_normaldivr > ul > li:nth-child(9)').text().split(u'省')[
                                                0] + u'省'
                missing_location_city = \
                dd('#table_1_normaldivr > ul > li:nth-child(9)').text().split(u'省')[-1].split(u'市')[0] + u'室'
                missing_location_town = \
                dd('#table_1_normaldivr > ul > li:nth-child(9)').text().split(u'省')[-1].split(u'市')[-1]
            else:
                missing_location_province = dd('#table_1_normaldivr > ul > li:nth-child(9)').text().split(',')[0]
                missing_location_city = ''
                missing_location_town = ''
